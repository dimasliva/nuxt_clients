<template>
    ...
    <v-toolbar color="primary">
        <v-toolbar-title>{{ props.creation? 'Новая запись на ' + props.event.start!.toLocaleDateString() : 'Запись на '+(props.event.start!.toLocaleDateString() +" в " + props.event.start!.toLocaleTimeString()) }}</v-toolbar-title>
        <v-spacer></v-spacer>
