...
export abstract class FinderDataProvider {
  ...
  constructor(@inject("MoApiClient") protected _MoApiClient: MoApiClient, @inject("UserContext") protected _UserContext: UserContext, @inject("diC") protected _diC: Container) {}
