<template>
  <v-row>
    <Table @cheked="checkEmpl = $event, disabledFunc(), $emit('clicked')" :info="data" :checkbox-show="show" :headers="th" :actions="tableActions"></Table>
...
mainBtnBar:[
    ...
    { id: "change", title: "Редактировать", icon: "mdi-pencil", disabled: editBtn.value, color:"secondary", bkgColor:"red", 
      action: () =>  openDialog(FormDialogForm, {empls: checkEmpl, onClose:()=>{console.log(checkEmpl.value)} }) },
    { id: "addEmployee", title: "Добавить", icon: "mdi-account", disabled:false, color:"secondary", bkgColor:"red", 
    action: () => openDialog(FormDialogFormTest,  {emplData: checkEmpl, onClose:()=>{console.debug("onClose invoked")} }) },
...
const disabledFunc = () =>{
  ...
  (checkEmpl.value.length == 1)? editBtn.value = false : editBtn.value = true;
  console.log(checkEmpl.value.length);
  pageDataLoad();
}


let th = [{title: "ID", key: "id"},{title: "ФИО", key: "name"},{title: "Телефон", key: "phone"}, {title: "E-mail", key: "email"}]

let data = ref([
  {id: "1",name: "Олег", phone: "1233-567-89-01", email: "Asmth@mail.com"},
  {id: "2",name: "Дмитрий", phone: "9234-557-89-01", email: "Bsmth@mail.com"},
  {id: "3",name: "Владимир", phone: "5234-800-89-01", email: "Csmth@mail.com"},
  {id: "4",name: "Ольга", phone: "2341-567-89-01", email: "Dsmth@mail.com"},
  {id: "5",name: "Вера", phone: "3114-567-89-01", email: "Esmth@mail.com"},
  {id: "6",name: "Дарья", phone: "4000-000-89-01", email: "Fsmth@mail.com"},
])
