...
import ScheduleItemGroupProfileDialog from '~forms/WindowDialogs/~sub/EditWindowDialogs/~sub/ProfileDialogs/ScheduleItemGroupProfileDialog.vue';
...
import { ScheduleViews } from '~/src/common/lib/MoApi/Views/ScheduleViews';
