...
import { EmployeeRecord, EmployeeRecordData } from '~/src/common/lib/MoApi/Records/EmployeeRecord';
import { EmployeeContactsRecord, EmployeeContactsRecordData } from '~/src/common/lib/MoApi/Records/EmployeeContactsRecord';
import { RecordsStore } from '~/src/common/lib/MoApi/Records/RecordsStore';
import { ClientRecord, ClientRecordData } from '~/src/common/lib/MoApi/Records/ClientRecord';
...
import { ScheduleItemRecord, ScheduleItemData } from '~/src/common/lib/MoApi/Records/ScheduleItemRecord';
...
import ScheduleTimeSpanEntity, { EEmployeeTimeTypes } from '~/src/common/lib/MoApi/Records/DataEntities/ScheduleTimeSpanEntity';
import { ProductGroupRecord, ProductGroupRecordData } from '~/src/common/lib/MoApi/Records/ProductGroupRecord';
import { ClientGroupRecord, ClientGroupRecordData } from '~/src/common/lib/MoApi/Records/ClientGroupRecord';
...
import { Locks } from '~/src/common/lib/MoApi/Locks';
import { ApiLock } from '~/src/common/lib/MoApi/ApiLock';
...
import { RelationApiSection } from '~/src/common/lib/MoApi/ApiSectionsV1/RelationApiSection';
import * as  BookingStatuses from '~/src/common/lib/Dicts/DictBookingStatusesConst';
import { ClientList } from '~/src/widgets/Lists/~sub/ClientListTemplate';
import TemplateFrame from '~/src/components/TemplateFrame.vue';
import { VBtn } from 'vuetify/components';
import MultiselectForm from '~forms/WindowDialogs/~sub/SelectForms/MultiselectForm.vue';
...
import { AddDealArgs } from '~/src/common/lib/MoApi/Records/DealRecord';
import { AddDealOrderArgs, DealOrderRecord } from '~/src/common/lib/MoApi/Records/DealOrderRecord';
import type { IPaymentParams } from '~/src/common/lib/MoApi/Records/Finance/IPaymentParams';
import { ECashFlowInstrumentCodes, ECashFlowOperationTypes, ECashFlowTypes } from '~/src/common/lib/MoApi/Records/Finance/FinanceEnums';
import { rand } from '@vueuse/core';
import { ContractRecord, type ContractRecordData } from '~/src/common/lib/MoApi/Records/ContractRecord';
import type { ApiRecord, ApiRecordClass } from '~/src/common/lib/MoApi/Records/ApiRecord';
import { OrganizationRecord, OrganizationRecordData } from '~/src/common/lib/MoApi/Records/OrganizationRecord';
