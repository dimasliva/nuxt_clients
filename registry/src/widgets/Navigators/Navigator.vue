...
import { useVTableScroll } from "../../ui_base/composibles/useVTableScroll"
import type { INavActionMenuItem, INavColumn, INavPathItem, INavRow, INavigatorContent, INavigatorProps } from "./types"
...
const { scrollTo, getCurrScrollPos } = useVTableScroll(refDt);
