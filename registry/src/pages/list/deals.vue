...
import { DealListTemplate } from "~/src/widgets/Lists/~sub/DealListTemplate";
...
export default {
  ...
  async setup(props, ctx) {
    ...
    const o = new DealListTemplate(diC, { settingsStorage: settingStorage });
     o.setup(props,ctx);
