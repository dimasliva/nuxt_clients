<template>
    <FormsEditWindowDialog title="Edit Deal" :on-save="save" :on-close="close" :readonly="readonly">
        ...
        <v-card-text>
          ...
          <v-row>
            <v-col xs="6" sm="6">
              <InputField
                :state="fieldsOptions"
                :type="EDataType.strictstringarray"
                label="Status"
                v-model="rec!.MData.status"
                required
              />
            </v-col>
            <v-col xs="6" sm="6">
